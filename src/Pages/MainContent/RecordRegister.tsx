...
<>
            ...
            <form id={"category"} className="p-4 flex flex-col items-center gap-10">
                ...
                <div
                    ...
                    <input type={"date"} name="categoria" className="font-open text-center text-gray-400 rounded-md drop-shadow-sm pl-2 py-1 outline-orange-300 border-orange-200 hover:border-orange-300 border-2 transition-all" />
                </div>
                <div
                    className="flex gap-4 items-center">
